...
describe('PlaybackRequestMatcher', () => {
  ...
  describe('responses', () => {
    ...
    it('returns the expected "isPending" value for deserialized requests.', () => {
      ...
      matcher.getResponseCollection('mock-intercepted-response-id-1');
      ...
      matcher.notifyRequestCompleted();
      matcher.getResponseCollection('mock-intercepted-response-id-2');
